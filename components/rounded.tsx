...
const MobileResponsiveComponent = () => {
  return (
    <div className="flex flex-col md:flex-col items-center justify-center gap-6 p-4 bg-gray-500 px-0">
      ...
      <div className="flex items-center gap-4 px-0">
        ...
        />
        <p className="text-lg font-semibold text-white-500 italic">Nagesh</p>
      </div>

      {/* Second image and name side by side */}
      <div className="flex items-center gap-4">
        <p className="text-lg font-semibold text-white-500 italic">Jaya</p>
        <Image
